 ...
 */
export function CostInstallmentsSection({ state, currency, total, panelCls, labelCls }: {
  ...
  return (
    <div className={panelCls} data-testid="installments-section">
      ...
      {drafts.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
          {drafts.map(d => (
            <div key={d.key} data-testid="installment-row" className="bg-surface-secondary border border-edge"
              style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 110px 150px auto auto', gap: 8, alignItems: 'center', padding: 8, borderRadius: 10, opacity: d.paid_at ? 0.75 : 1 }}>
