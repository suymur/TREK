...
import {
  ...
  type BudgetUpdateMembersRequest, type BudgetToggleMemberPaidRequest, type BudgetSetInstallmentPaidRequest, type BudgetReorderCategoriesRequest,
...
export const budgetApi = {
  ...
  setInstallmentPaid: (tripId: number | string, id: number, installmentId: number, paidAt: string | null) => apiClient.put(`/trips/${tripId}/budget/${id}/installments/${installmentId}/paid`, { paid_at: paidAt } satisfies BudgetSetInstallmentPaidRequest).then(r => r.data),
