  ...
  return {
    ...
    trips: [
      ...
      },
      {
        ...
        categories: [
          { category: 'accommodation', total: 200, display_total: 200, people: [{ user_id: 1, total: 200, display_total: 200 }], unassigned: none },
          { category: 'food', total: 56, display_total: 56, people: [], unassigned: { total: 56, display_total: 56 } },
          { category: 'flights', total: 150.5, display_total: 150.5, people: [{ user_id: 1, total: 150.5, display_total: 150.5 }], unassigned: none },
        ],
    ...
    total: 506.5,
    categories: [
      { category: 'accommodation', total: 200, people: [{ user_id: 1, total: 200 }], unassigned: 0 },
      { category: 'food', total: 76, people: [{ user_id: 1, total: 10 }, { user_id: 2, total: 10 }], unassigned: 56 },
      { category: 'transport', total: 80, people: [{ user_id: 1, total: 80 }], unassigned: 0 },
      { category: 'flights', total: 150.5, people: [{ user_id: 1, total: 150.5 }], unassigned: 0 },
    ],
