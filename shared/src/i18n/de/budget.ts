...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Status',
  'costs.status.estimate': 'Schätzung',
  'costs.status.final': 'Endgültig',
  'costs.status.estimateShort': 'ca.',
  'costs.status.hint': 'Schätzungen zählen zur geplanten Summe, aber nicht zur Abrechnung.',
  'costs.status.finalHint': 'Der geschätzte Betrag bleibt stehen. Korrigiere ihn, falls die echten Kosten abweichen.',
  'costs.totalEstimated': 'Geschätzt',
  'costs.totalPlanned': 'Geplant',
