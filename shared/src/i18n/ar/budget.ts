...
const budget: TranslationStrings = {
  ...
  'costs.customCat.new': 'فئة جديدة',
  'costs.customCat.edit': 'تعديل الفئة',
  'costs.customCat.name': 'الاسم',
  'costs.customCat.namePlaceholder': 'مثل: الزينة',
  'costs.customCat.icon': 'الأيقونة',
  'costs.customCat.color': 'اللون',
  'costs.customCat.shared': 'يرى الجميع على هذا الخادم الفئات المخصصة ويمكنهم استخدامها.',
  'costs.customCat.delete': 'حذف الفئة',
  'costs.customCat.deleteConfirm': 'حذف "{name}"؟ ستنتقل مصاريفها إلى أخرى في جميع الرحلات.',
  'costs.customCat.deleted': 'تم حذف الفئة. نُقل {count} من المصاريف إلى أخرى.',
  'costs.customCat.duplicate': 'توجد فئة بهذا الاسم بالفعل.',
  'costs.customCat.notAllowed': 'لا يمكن تغيير هذه الفئة إلا لمنشئها أو لمسؤول.',
  'costs.customCat.offline': 'لا يمكن تغيير الفئات إلا عند الاتصال بالإنترنت.',
  ...
  'costs.status': 'الحالة',
  'costs.status.estimate': 'تقدير',
  'costs.status.final': 'نهائي',
  'costs.status.estimateShort': 'تقديري',
  'costs.status.hint': 'تُحتسب التقديرات ضمن الإجمالي المخطط لكنها لا تدخل في التسوية.',
  'costs.status.finalHint': 'يبقى المبلغ المقدَّر كما هو. صحّحه إذا اختلفت التكلفة الفعلية.',
  'costs.totalEstimated': 'مُقدَّر',
  'costs.totalPlanned': 'مخطط',
