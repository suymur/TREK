...
const budget: TranslationStrings = {
  ...
  'costs.cat.other': '其他',
  'costs.customCat.new': '新增類別',
  'costs.customCat.edit': '編輯類別',
  'costs.customCat.name': '名稱',
  'costs.customCat.namePlaceholder': '例如：裝飾',
  'costs.customCat.icon': '圖示',
  'costs.customCat.color': '顏色',
  'costs.customCat.shared': '此伺服器上的所有人都能看到並使用自訂類別。',
  'costs.customCat.delete': '刪除類別',
  'costs.customCat.deleteConfirm': '刪除「{name}」？其支出將在所有行程中移至「其他」。',
  'costs.customCat.deleted': '類別已刪除。{count} 筆支出已移至「其他」。',
  'costs.customCat.duplicate': '已有同名類別。',
  'costs.customCat.notAllowed': '只有建立者或管理員可以變更此類別。',
  'costs.customCat.offline': '只能在連線時變更類別。',
  ...
  'costs.status': '狀態',
  'costs.status.estimate': '預估',
  'costs.status.final': '最終',
  'costs.status.estimateShort': '預估',
  'costs.status.hint': '預估費用計入計畫總額，但不參與結算。',
  'costs.status.finalHint': '預估金額會保留。如實際費用不同，請修改。',
  'costs.totalEstimated': '預估',
  'costs.totalPlanned': '計畫',
