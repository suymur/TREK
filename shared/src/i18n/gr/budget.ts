...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Κατάσταση',
  'costs.status.estimate': 'Εκτίμηση',
  'costs.status.final': 'Οριστικό',
  'costs.status.estimateShort': 'εκτ.',
  'costs.status.hint': 'Οι εκτιμήσεις μετρούν στο προγραμματισμένο σύνολο αλλά μένουν εκτός εκκαθάρισης.',
  'costs.status.finalHint': 'Το εκτιμώμενο ποσό παραμένει. Διόρθωσέ το αν το πραγματικό κόστος διαφέρει.',
  'costs.totalEstimated': 'Εκτιμώμενο',
  'costs.totalPlanned': 'Προγραμματισμένο',
