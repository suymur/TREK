...
const budget: TranslationStrings = {
  ...
  'costs.cat.other': '其他',
  'costs.customCat.new': '新建类别',
  'costs.customCat.edit': '编辑类别',
  'costs.customCat.name': '名称',
  'costs.customCat.namePlaceholder': '例如：装饰',
  'costs.customCat.icon': '图标',
  'costs.customCat.color': '颜色',
  'costs.customCat.shared': '此服务器上的所有人都能看到并使用自定义类别。',
  'costs.customCat.delete': '删除类别',
  'costs.customCat.deleteConfirm': '删除“{name}”？其支出将在所有行程中移至“其他”。',
  'costs.customCat.deleted': '类别已删除。{count} 笔支出已移至“其他”。',
  'costs.customCat.duplicate': '已存在同名类别。',
  'costs.customCat.notAllowed': '只有创建者或管理员可以更改此类别。',
  'costs.customCat.offline': '只能在联网时更改类别。',
  ...
  'costs.status': '状态',
  'costs.status.estimate': '预估',
  'costs.status.final': '最终',
  'costs.status.estimateShort': '预估',
  'costs.status.hint': '预估费用计入计划总额，但不参与结算。',
  'costs.status.finalHint': '预估金额会保留。如实际费用不同，请修改。',
  'costs.totalEstimated': '预估',
  'costs.totalPlanned': '计划',
