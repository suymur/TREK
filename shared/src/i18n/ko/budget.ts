...
const budget: TranslationStrings = {
  ...
  'costs.cat.other': '기타',
  'costs.customCat.new': '새 카테고리',
  'costs.customCat.edit': '카테고리 편집',
  'costs.customCat.name': '이름',
  'costs.customCat.namePlaceholder': '예: 장식',
  'costs.customCat.icon': '아이콘',
  'costs.customCat.color': '색상',
  'costs.customCat.shared': '사용자 지정 카테고리는 이 서버의 모든 사용자가 보고 사용할 수 있습니다.',
  'costs.customCat.delete': '카테고리 삭제',
  'costs.customCat.deleteConfirm': '"{name}"을(를) 삭제할까요? 해당 지출은 모든 여행에서 기타로 옮겨집니다.',
  'costs.customCat.deleted': '카테고리를 삭제했습니다. 지출 {count}건을 기타로 옮겼습니다.',
  'costs.customCat.duplicate': '같은 이름의 카테고리가 이미 있습니다.',
  'costs.customCat.notAllowed': '이 카테고리는 만든 사람이나 관리자만 변경할 수 있습니다.',
  'costs.customCat.offline': '카테고리는 온라인일 때만 변경할 수 있습니다.',
  ...
  'costs.status': '상태',
  'costs.status.estimate': '예상',
  'costs.status.final': '확정',
  'costs.status.estimateShort': '예상',
  'costs.status.hint': '예상 비용은 계획 합계에 포함되지만 정산에는 포함되지 않습니다.',
  'costs.status.finalHint': '예상 금액은 그대로 유지됩니다. 실제 비용이 다르면 수정하세요.',
  'costs.totalEstimated': '예상',
  'costs.totalPlanned': '계획',
