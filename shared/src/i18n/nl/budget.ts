...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Status',
  'costs.status.estimate': 'Schatting',
  'costs.status.final': 'Definitief',
  'costs.status.estimateShort': 'ca.',
  'costs.status.hint': 'Schattingen tellen mee in het geplande totaal, maar niet in de verrekening.',
  'costs.status.finalHint': 'Het geschatte bedrag blijft staan. Pas het aan als de echte kosten afwijken.',
  'costs.totalEstimated': 'Geschat',
  'costs.totalPlanned': 'Gepland',
