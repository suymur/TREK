...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Status',
  'costs.status.estimate': 'Estimate',
  'costs.status.final': 'Final',
  'costs.status.estimateShort': 'est.',
  'costs.status.hint': 'Estimates count toward the planned total but stay out of the settlement.',
  'costs.status.finalHint': 'The estimated amount stays in place. Correct it if the real cost differs.',
  'costs.totalEstimated': 'Estimated',
  'costs.totalPlanned': 'Planned',
