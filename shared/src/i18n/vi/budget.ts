...
const budget: TranslationStrings = {
  ...
  'costs.customCat.new': 'Danh mục mới',
  'costs.customCat.edit': 'Sửa danh mục',
  'costs.customCat.name': 'Tên',
  'costs.customCat.namePlaceholder': 'vd: Trang trí',
  'costs.customCat.icon': 'Biểu tượng',
  'costs.customCat.color': 'Màu',
  'costs.customCat.shared': 'Mọi người trên máy chủ này đều thấy và dùng được danh mục tùy chỉnh.',
  'costs.customCat.delete': 'Xóa danh mục',
  'costs.customCat.deleteConfirm': 'Xóa "{name}"? Các khoản chi của nó chuyển sang Khác, ở mọi chuyến đi.',
  'costs.customCat.deleted': 'Đã xóa danh mục. {count} khoản chi đã chuyển sang Khác.',
  'costs.customCat.duplicate': 'Đã có danh mục trùng tên này.',
  'costs.customCat.notAllowed': 'Chỉ người tạo hoặc quản trị viên mới đổi được danh mục này.',
  'costs.customCat.offline': 'Chỉ có thể đổi danh mục khi đang trực tuyến.',
  ...
  'costs.status': 'Trạng thái',
  'costs.status.estimate': 'Ước tính',
  'costs.status.final': 'Chính thức',
  'costs.status.estimateShort': 'ư.t.',
  'costs.status.hint': 'Khoản ước tính được tính vào tổng dự kiến nhưng không tham gia quyết toán.',
  'costs.status.finalHint': 'Số tiền ước tính được giữ nguyên. Hãy sửa nếu chi phí thực tế khác.',
  'costs.totalEstimated': 'Ước tính',
  'costs.totalPlanned': 'Dự kiến',
