...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Durum',
  'costs.status.estimate': 'Tahmin',
  'costs.status.final': 'Kesin',
  'costs.status.estimateShort': 'tahmini',
  'costs.status.hint': 'Tahminler planlanan toplama dahil edilir ama hesaplaşmaya girmez.',
  'costs.status.finalHint': 'Tahmini tutar korunur. Gerçek maliyet farklıysa düzeltin.',
  'costs.totalEstimated': 'Tahmini',
  'costs.totalPlanned': 'Planlanan',
