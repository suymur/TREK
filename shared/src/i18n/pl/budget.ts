...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Status',
  'costs.status.estimate': 'Szacunek',
  'costs.status.final': 'Ostateczny',
  'costs.status.estimateShort': 'szac.',
  'costs.status.hint': 'Szacunki wliczają się do planowanej sumy, ale nie do rozliczenia.',
  'costs.status.finalHint': 'Szacowana kwota zostaje. Popraw ją, jeśli rzeczywisty koszt jest inny.',
  'costs.totalEstimated': 'Szacowane',
  'costs.totalPlanned': 'Planowane',
