...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Állapot',
  'costs.status.estimate': 'Becslés',
  'costs.status.final': 'Végleges',
  'costs.status.estimateShort': 'becs.',
  'costs.status.hint': 'A becslések beleszámítanak a tervezett összegbe, de az elszámolásba nem.',
  'costs.status.finalHint': 'A becsült összeg megmarad. Javítsd, ha a tényleges költség eltér.',
  'costs.totalEstimated': 'Becsült',
  'costs.totalPlanned': 'Tervezett',
