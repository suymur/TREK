...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Stato',
  'costs.status.estimate': 'Stima',
  'costs.status.final': 'Definitivo',
  'costs.status.estimateShort': 'stima',
  'costs.status.hint': 'Le stime contano nel totale previsto ma restano fuori dal saldo.',
  'costs.status.finalHint': "L'importo stimato resta invariato. Correggilo se il costo reale è diverso.",
  'costs.totalEstimated': 'Stimato',
