...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Статус',
  'costs.status.estimate': 'Оцінка',
  'costs.status.final': 'Остаточний',
  'costs.status.estimateShort': 'оцін.',
  'costs.status.hint': 'Оцінки входять до запланованої суми, але не до розрахунку.',
  'costs.status.finalHint': 'Оцінена сума зберігається. Виправте її, якщо фактична вартість інша.',
  'costs.totalEstimated': 'Оцінено',
  'costs.totalPlanned': 'Заплановано',
