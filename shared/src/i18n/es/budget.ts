...
const budget: TranslationStrings = {
  ...
  'costs.customCat.new': 'Nueva categoría',
  'costs.customCat.edit': 'Editar categoría',
  'costs.customCat.name': 'Nombre',
  'costs.customCat.namePlaceholder': 'p. ej., Decoración',
  'costs.customCat.icon': 'Icono',
  'costs.customCat.color': 'Color',
  'costs.customCat.shared': 'Todos en este servidor ven las categorías personalizadas y pueden usarlas.',
  'costs.customCat.delete': 'Eliminar categoría',
  'costs.customCat.deleteConfirm': '¿Eliminar «{name}»? Sus gastos pasan a Otros en todos los viajes.',
  'costs.customCat.deleted': 'Categoría eliminada. {count} gastos pasaron a Otros.',
  'costs.customCat.duplicate': 'Ya existe una categoría con este nombre.',
  'costs.customCat.notAllowed': 'Solo quien la creó o un administrador puede cambiar esta categoría.',
  'costs.customCat.offline': 'Las categorías solo se pueden cambiar con conexión.',
  ...
  'costs.status': 'Estado',
  'costs.status.estimate': 'Estimación',
  'costs.status.final': 'Definitivo',
  'costs.status.estimateShort': 'est.',
  'costs.status.hint': 'Las estimaciones cuentan en el total previsto, pero quedan fuera de la liquidación.',
  'costs.status.finalHint': 'El importe estimado se mantiene. Corrígelo si el coste real es distinto.',
  'costs.totalEstimated': 'Estimado',
  'costs.totalPlanned': 'Previsto',
