...
const budget: TranslationStrings = {
  ...
  'costs.customCat.new': 'Новая категория',
  'costs.customCat.edit': 'Изменить категорию',
  'costs.customCat.name': 'Название',
  'costs.customCat.namePlaceholder': 'напр. Декор',
  'costs.customCat.icon': 'Значок',
  'costs.customCat.color': 'Цвет',
  'costs.customCat.shared': 'Свои категории видят и могут использовать все на этом сервере.',
  'costs.customCat.delete': 'Удалить категорию',
  'costs.customCat.deleteConfirm': 'Удалить «{name}»? Её расходы во всех поездках перейдут в «Другое».',
  'costs.customCat.deleted': 'Категория удалена. Расходов перенесено в «Другое»: {count}.',
  'costs.customCat.duplicate': 'Категория с таким названием уже есть.',
  'costs.customCat.notAllowed': 'Изменить эту категорию может только её автор или администратор.',
  'costs.customCat.offline': 'Категории можно менять только онлайн.',
  ...
  'costs.status': 'Статус',
  'costs.status.estimate': 'Оценка',
  'costs.status.final': 'Итоговый',
  'costs.status.estimateShort': 'оцен.',
  'costs.status.hint': 'Оценки входят в плановую сумму, но не участвуют во взаиморасчётах.',
  'costs.status.finalHint': 'Оценочная сумма сохраняется. Исправьте её, если фактическая стоимость отличается.',
  'costs.totalEstimated': 'Оценочно',
  'costs.totalPlanned': 'Запланировано',
