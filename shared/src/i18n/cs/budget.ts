...
const budget: TranslationStrings = {
  ...
  'costs.customCat.new': 'Nová kategorie',
  'costs.customCat.edit': 'Upravit kategorii',
  'costs.customCat.name': 'Název',
  'costs.customCat.namePlaceholder': 'např. Dekorace',
  'costs.customCat.icon': 'Ikona',
  'costs.customCat.color': 'Barva',
  'costs.customCat.shared': 'Vlastní kategorie vidí a mohou používat všichni na tomto serveru.',
  'costs.customCat.delete': 'Smazat kategorii',
  'costs.customCat.deleteConfirm': 'Smazat „{name}“? Její výdaje se ve všech cestách přesunou do Ostatní.',
  'costs.customCat.deleted': 'Kategorie smazána. Výdaje přesunuté do Ostatní: {count}.',
  'costs.customCat.duplicate': 'Kategorie s tímto názvem už existuje.',
  'costs.customCat.notAllowed': 'Tuto kategorii může změnit jen její autor nebo správce.',
  'costs.customCat.offline': 'Kategorie lze měnit jen online.',
  ...
  'costs.status': 'Stav',
  'costs.status.estimate': 'Odhad',
  'costs.status.final': 'Konečný',
  'costs.status.estimateShort': 'odh.',
  'costs.status.hint': 'Odhady se započítávají do plánované částky, ale ne do vyúčtování.',
  'costs.status.finalHint': 'Odhadnutá částka zůstává. Opravte ji, pokud se skutečná cena liší.',
  'costs.totalEstimated': 'Odhadnuto',
  'costs.totalPlanned': 'Plánováno',
