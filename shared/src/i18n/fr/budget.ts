...
const budget: TranslationStrings = {
  ...
  'costs.status': 'Statut',
  'costs.status.estimate': 'Estimation',
  'costs.status.final': 'Définitif',
  'costs.status.estimateShort': 'est.',
  'costs.status.hint': 'Les estimations comptent dans le total prévu mais restent hors du règlement.',
  'costs.status.finalHint': 'Le montant estimé est conservé. Corrigez-le si le coût réel diffère.',
  'costs.totalEstimated': 'Estimé',
  'costs.totalPlanned': 'Prévu',
