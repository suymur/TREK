...
const budget: TranslationStrings = {
  ...
  'costs.status': 'ステータス',
  'costs.status.estimate': '見積もり',
  'costs.status.final': '確定',
  'costs.status.estimateShort': '見込',
  'costs.status.hint': '見積もりは予定合計に含まれますが、精算には含まれません。',
  'costs.status.finalHint': '見積もり額はそのまま残ります。実際の金額が違う場合は修正してください。',
  'costs.totalEstimated': '見積もり',
  'costs.totalPlanned': '予定',
